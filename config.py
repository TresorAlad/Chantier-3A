...
ENV_ADDR = "CACKLE_ADDR"
ENV_DB = "CACKLE_DB"
ENV_DATABASE_URL = "CACKLE_DATABASE_URL"
ENV_BASE_URL = "CACKLE_BASE_URL"
ENV_SESSION_SECRET = "CACKLE_SESSION_SECRET"
ENV_MEDIA_DIR = "CACKLE_MEDIA_DIR"
ENV_HOST_SCOPE = "CACKLE_HOST_SCOPE"
ENV_HOST_ORG = "CACKLE_HOST_ORG"
ENV_HOST_NAME = "CACKLE_HOST_NAME"
ENV_COMMUNITY_MODE = "CACKLE_COMMUNITY_MODE"
ENV_SMTP_HOST = "CACKLE_SMTP_HOST"
ENV_SMTP_PORT = "CACKLE_SMTP_PORT"
ENV_SMTP_FROM = "CACKLE_SMTP_FROM"
ENV_SMTP_USER = "CACKLE_SMTP_USER"
ENV_SMTP_PASSWORD = "CACKLE_SMTP_PASSWORD"
ENV_PAYMENT_PROVIDERS = "CACKLE_PAYMENT_PROVIDERS"
ENV_PAYMENT_SERVICE_URL = "CACKLE_PAYMENT_SERVICE_URL"
ENV_PAYMENT_SERVICE_API_KEY = "CACKLE_PAYMENT_SERVICE_API_KEY"
ENV_PAYMENT_WEBHOOK_SECRET = "CACKLE_PAYMENT_WEBHOOK_SECRET"
ENV_PAYMENT_PROVIDER_NAME = "CACKLE_PAYMENT_PROVIDER_NAME"
ENV_PAYMENT_SERVICE_TIMEOUT = "CACKLE_PAYMENT_SERVICE_TIMEOUT"

DEFAULT_ADDR = ":8080"
DEFAULT_DB = "./cackle.db"
...
def _session_secret(db_path: str) -> str:
    ...
    if explicit:
        return explicit
    secret_path = Path(db_path).with_name(".cackle_session_secret")
...
def load_config(
    *,
    ...
    return Config(
        ...
        key_passphrase=_env("CACKLE_KEY_PASSPHRASE"),
